...
const DialogIn = ({ open, setOpen, product, handleDialogClose }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="w-[95%] rounded-lg sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Barang Masuk: {product?.name}</DialogTitle>
          <DialogDescription>
            Tolong diisi dengan benar, jangan sampai ada kesalahan, dan juga
            angka harus lebih besar dari sebelumnya
          </DialogDescription>
        </DialogHeader>
